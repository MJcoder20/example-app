        ...
        <form action="/" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    class="@error('username') is_invalid @enderror"/>
                </div>
                @error('username')
                    <div>{{$message}}</div>
                @enderror
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    class="@error('first_name') is_invalid @enderror"/>
                </div>
                @error('first_name')
                    <div>{{$message}}</div>
                @enderror
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    class="@error('last_name') is_invalid @enderror"/>
                </div>
                @error('last_name')
                    <div>{{$message}}</div>
                @enderror
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    class="@error('is_admin') is_invalid @enderror"/>
                </div>
                @error('is_admin')
                    <div>{{$message}}</div>
                @enderror
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                  ...
                  class="@error('is_active') is_invalid @enderror"/>
                </div>
                @error('is_active')
                    <div>{{$message}}</div>
                @enderror
