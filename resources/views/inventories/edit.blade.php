...
@section('content')
    <div class="container">
        <h1 style="font-size:40px;font-weight:bold">Update Inventory</h1>
        <div class="py-5 text-center" style="font-size:20px;">
        <form action="/inventories/{{$inventory->id}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                <input id="name" type="text" name="name" required value="{{$inventory->name}}"
            ...
            <button type="submit" class="btn btn-primary mb-2 btn-lg btn-block">{{ __('Update Inventory') }}</button>
